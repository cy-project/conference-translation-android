...
public class Meeting_settings_group extends ActivityGroup{

  
  public static Meeting_settings_group group;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    this.history = new ArrayList<View>();
      ...
      View view = getLocalActivityManager().startActivity("Activity2", new
        Intent(Meeting_settings_group.this, Meeting_settings.class)
